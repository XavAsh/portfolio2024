function switchLanguage() {
    ...
    if (language === 'fr') {
        ...
        document.getElementById('t1').textContent = '2023: Projet scolaire de deuxième année pour un site web de location de véhicules utilisant PHP procédural MVC, bases de données MySQL, HTML, CSS, JS.';
