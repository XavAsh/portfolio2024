function switchLanguage() {
    ...
    if (language === 'fr') {
        ...
        document.querySelector('#Portfolio .row .column:nth-child(1) p').textContent = '2023: Second year school project for a vehicle rental website dynamically using procedural MVC PHP, MySQL Databases, HTML, CSS, JS. Developed for local use only';
        document.querySelector('#Portfolio .column:nth-child(2) p').textContent = '2023: First year school project for a museum website using HTML, CSS, JS. Developed for local use only.';
